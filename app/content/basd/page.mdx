...
export const metadata = {
  title: 'BaSD',
  description: 'Blockchain at San Diego',
}
  ...
  <div className="max-w-4xl w-full px-8 py-16">
    ...
    <article className="space-y-8 leading-loose">
      <header className="mb-10">
        <h1 className="text-3xl font-normal mb-3 tracking-tight">BaSD</h1>
        <p className="text-neutral-500 dark:text-neutral-600">Blockchain at San Diego</p>
      </header>

      <h2 className="text-xl font-medium mt-10 mb-4">overview</h2>

      <p>
        Details about BaSD and engineering work.
      </p>
    </article>
  </div>
</div>
