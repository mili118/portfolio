...
<div className="min-h-screen bg-neutral-0 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 flex items-center justify-center">
  <div className="max-w-4xl w-full px-8 py-16">
    ...
    <article className="space-y-6 leading-loose text-base">
      ...
      <h2 className="text-2xl font-normal mt-10 mb-4">What is Semantic Data Engineering</h2>
      ...
      <h2 className="text-2xl font-normal mt-10 mb-4">A Potentially Problematic Approach</h2>
      ...
      <h2 className="text-2xl font-normal mt-10 mb-4">The Data Problem</h2>
      ...
      <h2 className="text-2xl font-normal mt-10 mb-4">Our Solution</h2>
      ...
      <h2 className="text-2xl font-normal mt-10 mb-4">Why Test on Pharmaceutical Research</h2>
      ...
      <h2 className="text-2xl font-normal mt-10 mb-4">Why I Think This Is Meaningful</h2>
